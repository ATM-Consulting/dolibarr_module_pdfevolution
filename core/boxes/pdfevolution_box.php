 ...
 */
class pdfevolutionbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "pdfevolution@pdfevolution";
    public $boxlabel;
    public $depends = array("pdfevolution");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/pdfevolution/class/pdfevolution.class.php";

...
/**
 * 	\file		core/triggers/interface_99_modMyodule_pdfevolutiontrigger.class.php
 * 	\ingroup	pdfevolution
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modPdfevolution_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacepdfevolutiontrigger
{

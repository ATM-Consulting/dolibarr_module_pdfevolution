...
/**
 *	\file       htdocs/core/modules/supplier_order/pdf/pdf_rivesaltes.modules.php
 *	\ingroup    fournisseur
 *	\brief      File of class to generate suppliers orders from rivesaltes model
 */
...
/**
 *	Class to generate the supplier orders with the rivesaltes model
 */
class pdf_rivesaltes_secp extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->SetTextColor(0,0,60);
		$title=$outputlangs->transnoentities("SupplierOrder")." ".$outputlangs->convToOutputCharset($object->ref)." ".$object->project->ref;
		$pdf->MultiCell(150, 3, $title, '', 'R');
		$posy+=1;

...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.pdfevolution.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[Tpdfevolution.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[Tpdfevolution.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[Tpdfevolution.STATUS_REFUSED]]
